  ...
  return (
    <div className={styles.letterPopUp}>
        <div className={styles.letter}>
            <div className={styles.letterIntro}>
            На Новый год за все свои мучения я хочу получить:
            </div>
            <div className={styles.letterPreferences} dangerouslySetInnerHTML={{ __html: replaceLinks(currentGift?.preferences) }}>
            </div>
        </div>
        <div className={styles.info}>
            <span className={styles.infoUsername}>
            Твой подарок получит<br/>@{currentGift.username}
            </span>
