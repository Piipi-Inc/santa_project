...
export class PreferencesStore {
  private readonly saveUserPreferences: ({ preferences }: { preferences: string }) => Promise<void>;
  ...
  constructor({
    ...
    saveUserPreferences: ({ preferences }: { preferences: string }) => Promise<void>;
  ...
  public handleButtonClick = async ({ preferences }: { preferences: string }) => {
  ...
  private setIsRunningAnimation = (isRunningAnimation: PreferencesStore['isRunningAnimation']) => {
